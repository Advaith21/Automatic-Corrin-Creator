...
# THIS IS FOR WEAPON RANKS
SWORD_RANK_INDEX = 126
LANCE_RANK_INDEX = 128
AXE_RANK_INDEX = 130
HIDDEN_RANK_INDEX = 132
BOW_RANK_INDEX = 134
TOME_RANK_INDEX = 136
STAFF_RANK_INDEX = 138
STONE_RANK_INDEX = 140

# THIS IS FOR INVENTORY (AABBCCDDEE, where DD is forge amt/number of uses, add 40 to DD if it's equipped).
ITEM_1_INDEX = 200
ITEM_2_INDEX = 210
ITEM_3_INDEX = 220
ITEM_4_INDEX = 230
